...
// Reviews Completed = the same weekly quota figure shown on the Call Detail
// header, QA Scoring screen, and Task Dashboard (mockQaScorecard.qaQuota,
// 12 of 15 → 80%). Labeled by what it actually measures — quota
// completion, not a score — since there's no fleet-wide score-average
// anywhere in this app (the one real score, from QA Scoring's
// weightedTotal(), belongs to a single in-progress draft, not an
// aggregate).
...
export const kpis: Kpi[] = [
  ...
  { id: 'qa-average', label: 'QA Reviews Completed', unit: 'percent', currentValue: qaAverageValue, volatility: 5, goodDirection: 'up' },
